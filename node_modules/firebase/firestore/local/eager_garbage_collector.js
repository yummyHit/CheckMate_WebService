...
exports.EagerGarbageCollector = undefined;
...
var EagerGarbageCollector = /** @class */function () {
    function EagerGarbageCollector() {
         ...
         */
        this.potentialGarbage = (0, _collections.documentKeySet)();
    }
    ...
    EagerGarbageCollector.prototype.collectGarbage = function (txn) {
        var _this = this;
        var promises = [];
        var garbageKeys = (0, _collections.documentKeySet)();
    ...
    EagerGarbageCollector.prototype.documentHasAnyReferences = function (txn, key) {
        var initial = _persistence_promise.PersistencePromise.resolve(false);
        return this.sources.map(function (source) {
            ...
            return promise.next(function (result) {
                if (result) {
                    return _persistence_promise.PersistencePromise.resolve(true);
                } else {
                    return nextPromise();
                }
            });
