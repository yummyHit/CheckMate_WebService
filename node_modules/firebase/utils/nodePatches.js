...
_BrowserPollConnection.FirebaseIFrameScriptHolder.nodeRestRequest = function (req, onComplete) {
    if (!_BrowserPollConnection.FirebaseIFrameScriptHolder.request) _BrowserPollConnection.FirebaseIFrameScriptHolder.request = /** @type {function({url: string, forever: boolean}, function(Error, number, string))} */require('request');
